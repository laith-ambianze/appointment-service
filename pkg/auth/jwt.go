...
// Note: ExternalUserID is the user identifier from the integrating product's system.
// The Appointment Service does NOT store users internally - it relies on external user IDs.
type Claims struct {
